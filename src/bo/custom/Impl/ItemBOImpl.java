...
public class ItemBOImpl implements ItemBO {
    ...
    public boolean addItem(ItemDTO Item) throws ClassNotFoundException, SQLException {
        return itemDAO.add(new Item(Item.getItemCode(), Item.getSupplierID(), Item.getDescription(), Item.getPackSize(), Item.getUnitPrice(), Item.getQtyOnHand(), Item.getBatchID()));
    }
    ...
    public boolean updateItem(ItemDTO id) throws ClassNotFoundException, SQLException {
        return itemDAO.update(new Item(id.getItemCode(), id.getSupplierID(), id.getDescription(), id.getPackSize(), id.getUnitPrice(), id.getQtyOnHand(), id.getBatchID()));
    }
