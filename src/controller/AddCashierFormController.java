...
public class AddCashierFormController implements Initializable {
    ...
    CashierBO cashierBO = new CashierBOImpl();
    String picName;
    ...
    public void addOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            String title = "Cashier Is Already On The Sever";
...
//            String castlogin =     txtCashierID.getText();
//            String castpassword =  txtPassword.getText();
//            CashierDTO cashierDTO = new CashierDTO(castID, castName, castBirthDay, castAddress, castPhoto, castlogin, castpassword);
    ...
    public void cashierUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            String castlogin = txtLogin.getText();
            String castpassword = txtPassword.getText();
            CashierDTO cashierDTO = new CashierDTO(castID, castName, castBirthDay, castAddress, "castPhoto", castlogin, castpassword);
