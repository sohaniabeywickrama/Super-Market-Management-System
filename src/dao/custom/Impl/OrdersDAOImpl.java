...
public class OrdersDAOImpl implements OrdersDAO {
    ...
    public boolean add(Orders ID) throws ClassNotFoundException, SQLException {
        ...
        return CrudUtil.executeUpdate(sql, ID.getOrderID(), ID.getOrderDate(), ID.getOrderTime(), ID.getCustName(), ID.getCustPhoneNo(), ID.getCustAddress(), ID.getCustEmail(), ID.getCustID());
    }
