...
public class ItemDAOImpl implements ItemDAO {
    ...
    public boolean add(Item ID) throws ClassNotFoundException, SQLException {
        ...
        return CrudUtil.executeUpdate(sql, ID.getItemCode(), ID.getSupplierID(), ID.getDescription(), ID.getPackSize(), ID.getUnitPrice(), ID.getQtyOnHand(), ID.getBatchID());
    }
    ...
    public boolean update(Item ID) throws ClassNotFoundException, SQLException {
        String sql = "update item set supplierID=?,Description=?,packSize=?,unitPrice=?,QtyOnHand=?,BatchID=? where itemCode=?";
        return CrudUtil.executeUpdate(sql, ID.getSupplierID(), ID.getDescription(), ID.getPackSize(), ID.getUnitPrice(), ID.getQtyOnHand(), ID.getBatchID(), ID.getItemCode());
    }
