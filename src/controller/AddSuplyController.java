...
public class AddSuplyController implements Initializable {
    ...
    public void searchOnAction() {
        try {
            ...
            SuplayDTO searchSuplay = suplayBO.searchSuplay(suplayID);
            if (searchSuplay != null) {
                txtSupId.setText(searchSuplay.getSuplayerID());
                txtCompanyName.setText(searchSuplay.getSuplayerName());
                txtAddress.setText(searchSuplay.getSuplayerAddress());
                txtPhoneNo.setText(searchSuplay.getSuplayerPhone());
                txtEmail.setText(searchSuplay.getSuplayerEmail());
    ...
    public void updateOnAction() {
        try {
            ...
            String title;
            String message;
            controller.TrayNotification tray = new controller.TrayNotification();
            AnimationType type = AnimationType.POPUP;
            tray.setAnimationType(type);
            if (updateCustomer) {
