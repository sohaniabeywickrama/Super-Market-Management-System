...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public boolean add(Customer ID) throws ClassNotFoundException, SQLException {
        ...
        return CrudUtil.executeUpdate(sql, ID.getCustID(), ID.getCustTitle(), ID.getCustName(), ID.getCustPhoneNo(), ID.getCustAddress(), ID.getCustEmail(), ID.getCity(), ID.getProvince(), ID.getRegDate());
    }
    ...
    public boolean update(Customer ID) throws ClassNotFoundException, SQLException {
        String sql = "update Customer set custTitle =?,custName=?,custPhoneNo=?,custAddress=?,custEmail=?,city=?,province=?,RegDate=? where custID=?";
        return CrudUtil.executeUpdate(sql, ID.getCustTitle(), ID.getCustName(), ID.getCustPhoneNo(), ID.getCustAddress(), ID.getCustEmail(), ID.getCity(), ID.getProvince(), ID.getRegDate(), ID.getCustID());
    }
