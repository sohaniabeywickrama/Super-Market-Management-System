...
public class AddItemFormController implements Initializable {
    ...
    public void addOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            String title = "Item Is Already On The Server";
    ...
    public void searchOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (searchItem != null) {
                ...
                txtSupID.setText(searchItem.getSupplierID());
                txtBatchId.setText(searchItem.getBatchID());
                String title = "Item Searched ";
                ...
                String title = "Searched Item Is Not Found";
    ...
    public void updateOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            ItemDTO itemDTO = new ItemDTO(itemCode, supplierID, Description, packSize, unitPrice, QtyOnHand, BatchID);
